...
def getArgs():
    ...
    parser.add_argument("-c", help = "input the configuration file id", dest = "id", type=str, default="0")
    ...
    parser.add_argument("-l", help = "input the path to save logs", dest = "log_path", type = str, default = "../../output/elevate_gpt_10min/")
    parser.add_argument("-o", help = "input the path to save results", dest = "res_path", type = str, default = "../../output/elevate_gpt_10min/result/")
    parser.add_argument("-m", help = "input the LLM: Llama, Deepseek, GPT", dest = "llm", type = str, default = "GPT")

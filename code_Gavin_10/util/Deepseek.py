    ...
    def step2_chat(self, Ques):
        ...
        if self.__useAPI == True:
            ...
            if hasGlobal2 == False:
                ...
                print("Step2_User:\n" + promptBody + "\n")
            gpt_response = input("Step2_Deepseek:\n")
        self.__record_result(self.__Step2_Recorder_Path, "Deepseek:\n" + gpt_response + "\n")
    ...
    def step3_chat(self, states, state, transitions, candidate_Inpt_list):
        ...
        if self.__useAPI == True:
            ...
            if hasGlobal3 == False:
                ...
                print("Step3_User:\n" + promptBody + "\n")
            response = input("Step3_Deepseek:\n")

        self.__record_result(self.__Step3_Recorder_Path, "Deepseek:\n" + response + "\n")
